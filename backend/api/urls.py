...
from .views import DocMappingList, DocMappingDetail, RandomDocMappingAPI
...
urlpatterns = [
     ...
     path('projects/<int:project_id>/randomdocmapping',
         RandomDocMappingAPI.as_view(), name='random_docmapping'),
]
